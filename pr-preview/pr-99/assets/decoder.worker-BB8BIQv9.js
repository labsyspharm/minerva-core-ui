...
let __tla = (async ()=>{
    ...
    addDecoder([
        undefined,
        1
    ], ()=>import('./raw-DDk4uA0K.js').then((m)=>m.default), false);
    addDecoder(5, ()=>import('./lzw-Qaj4DHTb.js').then((m)=>m.default));
    addDecoder(6, ()=>{
        throw new Error('old style JPEG compression is not supported.');
    });
    addDecoder(7, ()=>import('./jpeg-4cauYQ31.js').then((m)=>m.default));
    addDecoder([
        8,
        32946
    ], ()=>import('./deflate-C8nu7dVJ.js').then((m)=>m.default));
    addDecoder(32773, ()=>import('./packbits-BKP1dTU0.js').then((m)=>m.default));
    addDecoder(34887, ()=>import('./lerc-DfO9qGah.js').then(async (m)=>{
            await m.zstd.init();
            return m;
        }).then((m)=>m.default));
    addDecoder(50000, ()=>import('./zstd-CGOK3URf.js').then(async (m)=>{
            await m.zstd.init();
            return m;
        }).then((m)=>m.default));
    addDecoder(50001, ()=>import('./webimage-BKFp6ZRm.js').then((m)=>m.default), false);
    ...
    async function E(I) {
        ...
        return A = g.exports, E.__wbindgen_wasm_module = B, A;
    }
    var D = Object.freeze({
        __proto__: null,
        decompress: function(I, Q) {
            try {
                const F = A.__wbindgen_add_to_stack_pointer(-16);
                var E = function(A, I) {
                    const Q = I(1 * A.length);
                    return g().set(A, Q / 1), B = A.length, Q;
                }(I, A.__wbindgen_malloc), D = B;
                A.decompress(F, E, D, Q);
                var i = C()[F / 4 + 0], w = C()[F / 4 + 1], G = (o = i, N = w, g().subarray(o / 1, o / 1 + N)).slice();
                return A.__wbindgen_free(i, 1 * w), G;
            } finally{
    ...
    const G = function(A) {
        let I, g = A.endsWith("==") ? 2 : A.endsWith("=") ? 1 : 0, B = A.length, Q = new Uint8Array(B / 4 * 3);
        for(let g = 0, C = 0; g < B; g += 4, C += 3)I = w(A.charCodeAt(g)) << 18 | w(A.charCodeAt(g + 1)) << 12 | w(A.charCodeAt(g + 2)) << 6 | w(A.charCodeAt(g + 3)), Q[C] = I >> 16, Q[C + 1] = I >> 8 & 255, Q[C + 2] = 255 & I;
        return Q.subarray(0, Q.length - g);
