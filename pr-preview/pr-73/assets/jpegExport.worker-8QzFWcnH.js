...
function padGrayscaleRgbaToTile(rgba, width, height, tileWidth = JPEG_PYRAMID_TILE_SIZE, tileLength = JPEG_PYRAMID_TILE_SIZE) {
...
async function encodeGrayscaleJpeg(width, height, pixels, lowerLimit, upperLimit, quality = JPEG_EXPORT_QUALITY, transfer = "contrast", padTileWidth, padTileLength) {
