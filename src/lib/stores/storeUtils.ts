 ...
 *
 * - **Wire preprocess** — re-exported from `wirePreprocess` (legacy key migration before Zod).
 ...
 *
 * Uses only `import type` from `documentSchema` / `authoring/config` to avoid runtime cycles.
 */
...
import { isUuid } from "./wirePreprocess";
