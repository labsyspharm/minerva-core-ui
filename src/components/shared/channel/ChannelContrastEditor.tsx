...
import { applyGroupChannelRange } from "@/lib/stores/storeUtils";
...
export function ChannelContrastEditor(props: ChannelContrastEditorProps) {
  ...
  const commitRange = React.useCallback(
    ...
    [channelGroups, props.groupId, props.channelId, setChannelGroups],
  );
  ...
  React.useEffect(() => {
    return () => {
      ...
      if (
        ...
        channelRendering.groupId === props.groupId &&
        channelRendering.channelId === props.channelId
      ) {
