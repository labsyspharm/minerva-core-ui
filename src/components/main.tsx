...
import { Upload } from "src/components/shared/components/Upload";
...
import { FileHandler } from "src/components/shared/components/FileHandler";
...
import { ChannelPanel } from "src/components/shared/components/ChannelPanel/ChannelPanel";
import { Presentation } from "src/components/playback/Presentation";

import type { DicomIndex, DicomLoader } from "src/lib/dicom-index";
import type { ValidObj } from "src/components/shared/components/Upload";
import type { ImageProps } from "src/components/shared/components/ChannelPanel/ChannelPanel";
