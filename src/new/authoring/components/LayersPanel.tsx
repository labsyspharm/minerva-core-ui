...
import { ItemList, type ListItem } from "src/components/common/ItemList";
import { RectangleIcon, EllipseIcon, PolylineIcon, PolygonIcon, LineIcon, GroupIcon, PointIcon, TextIcon } from "src/new/viewer/layers/overlays/icons";
import styles from "src/new/viewer/layers/overlays/index.module.css";
